...
# `rtimecapsule`: Automated File Backup and Restoration for R Projects
...
- 🔄 **Automatic Background Backups**: Non-blocking file monitoring that runs while you work
...
A: No, rtimecapsule only tracks files within the `RStudio`  project root directory.
